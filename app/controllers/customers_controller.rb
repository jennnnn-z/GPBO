class CustomersController < ApplicationController
  ...
  def create 
    ...
    # end
    if @customer.save 
      redirect_to @customer, "#{@customer.proper_name} was added to the system."
    else 
      render action: 'new'
    end
  end
  ...
  private 
    ...
    def cust_params 
      params.require(:customer).permit(:first_name, :last_name, :email, :phone, :user_id, :active)
    end

  # def user_params 
  #   params.require(:customer).permit(:username, :password_digest, :active)
  # end
end
end 